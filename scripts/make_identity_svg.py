...
def render() -> str:
  ...
  <style>
    ...
    .mark {{ fill: none; stroke: url(#fr); stroke-width: 34; stroke-linecap: square; stroke-linejoin: round; stroke-dasharray: 720; stroke-dashoffset: 720; animation: draw 1.25s cubic-bezier(.4,0,.2,1) forwards; }}
    .mark-back {{ fill: none; stroke: #123a50; stroke-width: 34; stroke-linecap: square; stroke-linejoin: round; opacity: .75; }}
    ...
    @media (prefers-reduced-motion: reduce) {{ .reveal {{ opacity: 1; transform: none; animation: none; }} .mark {{ stroke-dashoffset: 0; animation: none; }} .cursor {{ animation: none; }} }}
  </style>
  ...
  <g transform="translate(5 6)" aria-hidden="true">
    <path class="mark-back" d="M72 266V92H190 M72 174H166"/>
    <path class="mark-back" d="M238 266V92H316C354 92 374 110 374 140C374 169 354 187 316 187H238 M313 187L382 266"/>
  </g>
  <g filter="url(#softGlow)" aria-label="FR">
    <path class="mark" d="M72 266V92H190 M72 174H166"/>
    <path class="mark" d="M238 266V92H316C354 92 374 110 374 140C374 169 354 187 316 187H238 M313 187L382 266"/>
  </g>
